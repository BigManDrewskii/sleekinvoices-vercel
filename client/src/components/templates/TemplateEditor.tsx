...
export function TemplateEditor({
  ...
  const hslAdjustments: HSLAdjustments = {
    hueShift,
    saturationMult,
    lightnessMult,
  };
  const adjustedPrimaryColor = applyHSLAdjustments(
    primaryColor,
    hslAdjustments
  );
  const adjustedSecondaryColor = applyHSLAdjustments(
    secondaryColor,
    hslAdjustments
  );
  const adjustedAccentColor = applyHSLAdjustments(accentColor, hslAdjustments);
  const adjustedBackgroundColor = applyHSLAdjustments(
    backgroundColor,
    hslAdjustments
  );
                    ...
                    <div className="flex-1 space-y-1">
                      <div className="flex gap-1">
                        <div
                          ...
                          title={`Original: ${primaryColor}`}
                        />
                        <div
                          className="h-6 flex-1 rounded ring-2 ring-primary/50"
                          style={{ backgroundColor: adjustedPrimaryColor }}
                          title={`Adjusted: ${adjustedPrimaryColor}`}
                        />
                      </div>
                      <div className="flex gap-1">
                        <div
                          ...
                          title={`Original: ${secondaryColor}`}
                        />
                        <div
                          className="h-6 flex-1 rounded ring-2 ring-primary/50"
                          style={{ backgroundColor: adjustedSecondaryColor }}
                          title={`Adjusted: ${adjustedSecondaryColor}`}
                        />
                      </div>
                      <div className="flex gap-1">
                        <div
                          ...
                          title={`Original: ${accentColor}`}
                        />
                        <div
                          className="h-6 flex-1 rounded ring-2 ring-primary/50"
                          style={{ backgroundColor: adjustedAccentColor }}
                          title={`Adjusted: ${adjustedAccentColor}`}
                        />
                      </div>
                    </div>
                  </div>
