...
export function GearLoader({ className, size = "md" }: GearLoaderProps) {
  ...
  return (
    <div
      className={cn(
        "gearbox relative overflow-hidden rounded-md",
        config.container,
        className
      )}
      style={{
    ...
    >
      <div
        className="overlay absolute inset-0 rounded-md z-10 pointer-events-none"
    ...
    >
      ...
      <div
        style={{
          ...
          zIndex: 3,
          boxShadow:
            "0px 0px 10px rgba(255, 255, 255, 0.1), inset 0px 0px 10px rgba(0, 0, 0, 0.1), inset 0px 2px 0px 0px #090909, inset 0px -1px 0px 0px #888888",
        }}
      />
    </div>
  );
