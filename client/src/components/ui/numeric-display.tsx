 ...
 */
export function NumericDisplay({ children, className, bold, variant }: NumericDisplayProps) {
  const isBold = bold || variant === "bold";

  return (
    <span className={cn(isBold ? "font-numeric-bold" : "font-numeric", className)}>
      {children}
    </span>
  );
}
 ...
 */
export function CurrencyDisplay({ children, className, bold }: Omit<NumericDisplayProps, "variant">) {
  return (
 ...
 */
export function InvoiceNumber({ children, className }: Omit<NumericDisplayProps, "bold" | "variant">) {
  return (
 ...
 */
export function MetricValue({ children, className }: Omit<NumericDisplayProps, "bold" | "variant">) {
  return (
