...
export default function QuickBooksCallback() {
  ...
  useEffect(() => {
    ...
    if (!code || !realmId) {
      setStatus("error");
      setErrorMessage("Missing authorization code or realm ID");
      return;
    }
    if (!state) {
      setStatus("error");
      setErrorMessage("Invalid session state. Please try connecting again.");
      return;
    }
        ...
        <CardHeader className="text-center">
          ...
          <CardDescription>
            {status === "loading"
              ...
              : status === "success"
                ? "Your QuickBooks account has been connected"
