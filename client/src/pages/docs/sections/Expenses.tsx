...
export const Expenses = () => (
  <div>
    ...
    <OL>
      <LI>
        Click <Strong>Expenses</Strong> in the Finances menu
      </LI>
      <LI>
      ...
      <LI>
        ...
        <UL>
          <LI>
            <Strong>Description</Strong> (e.g., "Adobe Creative Cloud
            subscription")
          </LI>
          <LI>
            <Strong>Category</Strong> (Software, Equipment, Travel, etc.)
          </LI>
          <LI>
            <Strong>Vendor</Strong> (optional)
          </LI>
          <LI>
          ...
          <LI>
            <Strong>Payment Method</Strong> (Credit Card, Cash, Bank Transfer,
            etc.)
          </LI>
          <LI>
            <Strong>Tax Amount</Strong> (if applicable)
          </LI>
          <LI>
            <Strong>Billable</Strong> (checkbox if you want to bill this to a
            client)
          </LI>
          <LI>
            <Strong>Receipt</Strong> (upload receipt image for documentation)
          </LI>
        </UL>
      </LI>
      <LI>
    ...
    <OL>
      <LI>
        Check the <Strong>Billable</Strong> checkbox when creating the expense
      </LI>
      <LI>
        When creating an invoice for that client, click{" "}
        <Strong>Add Billable Expenses</Strong>
      </LI>
    ...
    <P>This streamlines billing clients for reimbursable expenses.</P>

    <SubsectionHeading>Expense Categories</SubsectionHeading>
    <P>Create custom expense categories to organize spending:</P>

    <OL>
      <LI>
        Go to <Strong>Expenses</Strong>
      </LI>
      <LI>
        Click <Strong>Manage Categories</Strong>
      </LI>
      <LI>
    ...
    <P>View expense summaries:</P>

    <OL>
      <LI>
        Go to <Strong>Expenses</Strong> page
      </LI>
