...
export const Subscription = () => (
  <div>
    ...
    <P>
      <Strong>Free Plan</Strong>: $0/month, 3 invoices/month, core features, no
      credit card required.
    </P>
    <P>
      <Strong>Pro Plan</Strong>: $12/month, unlimited invoices, all premium
      features, priority support.
    </P>

    <SubsectionHeading>Upgrading to Pro</SubsectionHeading>
    <P>
      1. Click your <Strong>avatar</Strong> in the top-right corner
      <br />
      2. Select <Strong>Subscription</Strong>
      <br />
      3. Click <Strong>Upgrade to Pro</Strong>
      <br />
      4. Choose payment method:
    </P>
    <UL>
      <LI>
        <Strong>Credit Card</Strong>: Pay monthly via Stripe
      </LI>
      <LI>
        <Strong>Cryptocurrency</Strong>: Pay with Bitcoin, Ethereum, or 300+
        cryptocurrencies
      </LI>
    </UL>
    <P>
    ...
    <P>
      ...
      <br />
      2. Choose subscription duration (1, 3, 6, or 12 months)
      <br />
      3. Receive payment address and QR code
      <br />
      4. Send cryptocurrency to the address
      <br />
      5. Payment confirmed within minutes
      <br />
    ...
    <P>
      1. Go to <Strong>Subscription</Strong> page
      <br />
      2. View:
    </P>
    <UL>
    ...
    <UL>
      <LI>
        <Strong>Extend with Crypto</Strong>: Add more months to your
        subscription
      </LI>
      <LI>
        <Strong>Manage Billing</Strong>: Update payment method or cancel
      </LI>
    </UL>

    <SubsectionHeading>Canceling Your Subscription</SubsectionHeading>
    <P>
      1. Go to <Strong>Subscription</Strong>
      <br />
      2. Click <Strong>Manage Billing</Strong>
      <br />
      3. Select <Strong>Cancel Subscription</Strong>
      <br />
      4. Confirm cancellation
    </P>
    <P>
      You'll revert to the Free plan at the end of your current billing period.
    ...
    <P>
      <Strong>Purchase Additional Credits</Strong>:
    </P>
    <P>
      1. Go to <Strong>Dashboard</Strong> → <Strong>Magic Invoice</Strong>{" "}
      section
      <br />
      2. If low on credits, click <Strong>Top Up Credits</Strong>
      <br />
