...
export const Troubleshooting = () => (
  <div>
    ...
    <UL>
      <LI>
        Check the client's email address is correct (go to{" "}
        <Strong>Clients</Strong> and verify)
      </LI>
      <LI>Ask the client to check spam/junk folder</LI>
      <LI>Resend the invoice from the invoice details page</LI>
      <LI>
        Verify your email domain is configured (go to <Strong>Settings</Strong>{" "}
        → <Strong>Email</Strong>)
      </LI>
    </UL>
    ...
    <P>
      <Strong>Problem</Strong>: Client says they paid but invoice still shows
      unpaid.
    </P>
    <P>
      <Strong>Solutions</Strong>:
    ...
    <UL>
      <LI>
        Check your Stripe account for the payment (log into Stripe dashboard)
      </LI>
      <LI>
        Manually record the payment in SleekInvoices (go to invoice →{" "}
        <Strong>Record Payment</Strong>)
      </LI>
      <LI>
        For crypto payments, verify the transaction on the blockchain using the
        transaction hash
      </LI>
      <LI>
        Contact support if payment appears in Stripe but not in SleekInvoices
      </LI>
    </UL>

    <SubsectionHeading>Crypto Payment Not Confirming</SubsectionHeading>
    <P>
      <Strong>Problem</Strong>: Client sent cryptocurrency but payment not
      confirmed.
    </P>
    <P>
      <Strong>Solutions</Strong>:
    ...
    <UL>
      <LI>
        Verify the transaction on the blockchain (Bitcoin, Ethereum explorer)
      </LI>
    ...
    <UL>
      <LI>
        Verify QuickBooks is still connected (go to <Strong>Settings</Strong> →{" "}
        <Strong>Integrations</Strong>)
      </LI>
      <LI>Check sync settings are enabled for that invoice type</LI>
      <LI>
        Manually sync by clicking the <Strong>three-dot menu</Strong> →{" "}
        <Strong>Sync to QuickBooks</Strong>
      </LI>
    ...
    <P>
      <Strong>Problem</Strong>: Magic Invoice doesn't generate or generates
      incorrect results.
    </P>
    <P>
      <Strong>Solutions</Strong>:
    ...
    <UL>
      ...
      <LI>
        Ensure your description is clear and specific (e.g., "10 hours of web
        design at $75/hour")
      </LI>
    ...
    <P>
      <Strong>Problem</Strong>: "Monthly invoice limit reached" error when
      creating invoice.
    </P>
    <P>
      <Strong>Solutions</Strong>:
    ...
    <UL>
      ...
      <LI>
        Delete draft invoices to free up space (only sent invoices count toward
        limit)
      </LI>
    </UL>
    ...
    <UL>
      <LI>
        Clear your browser cache (Ctrl+Shift+Delete on Windows, Cmd+Shift+Delete
        on Mac)
      </LI>
    ...
    <UL>
      ...
      <LI>
        Check if the data was deleted (deleted items can sometimes be recovered)
      </LI>
