...
export const AccountSetup = () => (
  <div>
    ...
    <OL>
      <LI>
        Visit <Strong>SleekInvoices.com</Strong> and click{" "}
        <Strong>"Start Free"</Strong>
      </LI>
      <LI>Choose your sign-up method (email, Google, or GitHub)</LI>
      <LI>Verify your email address</LI>
      <LI>
        You're ready to go! Your account is automatically created with the Free
        plan
      </LI>
    </OL>
    ...
    <OL>
      <LI>
        Click the <Strong>avatar icon</Strong> in the top-right corner
      </LI>
      <LI>
    ...
    <P>Your company details appear in the "From" section of invoices:</P>
    <OL>
      <LI>
        Go to <Strong>Settings</Strong> → <Strong>Company Info</Strong>
      </LI>
    ...
    <CalloutBox title="Pro Tip">
      Your logo appears on all invoices and in your client portal. Use a
      high-quality image for professional appearance.
    </CalloutBox>

    <SubsectionHeading>Customizing Invoice Appearance</SubsectionHeading>
    <OL>
      <LI>
        Navigate to <Strong>Templates</Strong> in the main menu
      </LI>
      <LI>
        Choose between <Strong>Receipt Style</Strong> (thermal receipt
        aesthetic) or <Strong>Classic</Strong> (traditional invoice)
      </LI>
      <LI>
        Customize:
        <ul className="list-disc list-inside ml-6 mt-2 space-y-1 text-muted-foreground">
          ...
          <li>
            Field visibility (show/hide company address, payment terms, tax,
            discount, notes)
          </li>
    ...
    <P>Changes apply to all new invoices immediately.</P>
  </div>
);
