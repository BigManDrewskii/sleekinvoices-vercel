...
export default function Analytics() {
  ...
  const chartData = monthlyRevenue.map(
    (item: { month: string; revenue: string | number }) => {
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <Card className="bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20">
            <CardContent className="p-6">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span
                  className={`text-sm font-medium ${revenueChangePercent >= 0 ? "text-green-500" : "text-destructive"}`}
                >
                  <AnimatedPercentage
          ...
          {/* Overdue */}
          <Card
            className={`bg-gradient-to-br ${overdueAmount > 0 ? "from-red-500/5 to-red-500/10 border-destructive/20" : "from-green-500/5 to-green-500/10 border-green-500/20"}`}
          >
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-3">
                <div
                  className={`p-2 rounded-lg ${overdueAmount > 0 ? "bg-destructive/10" : "bg-green-500/10"}`}
                >
                  <AlertTriangle
                    className={`h-5 w-5 ${overdueAmount > 0 ? "text-destructive" : "text-green-500"}`}
                  />
                </div>
                <span className="text-sm font-medium text-muted-foreground">
                  Overdue
              ...
              {chartData.length > 0 && chartData.some(d => d.revenue > 0) ? (
                ...
                <div className="h-full flex flex-col items-center justify-center text-muted-foreground">
                  ...
                  <p className="text-xs mt-1">
                    Create invoices to see your revenue trend
                  </p>
                </div>
              )}
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <Card className="hover:border-primary/30 transition-colors">
            <CardContent className="p-5">
              ...
              <p className="text-3xl font-numeric-bold text-foreground">
                {totalInvoices}
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="hover:border-green-500/30 transition-colors">
            <CardContent className="p-5">
              ...
              <p className="text-3xl font-numeric-bold text-green-500">
                {paidInvoices}
              </p>
            </CardContent>
          </Card>
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-4">
              {[
                ...
                const percentage =
                  totalOutstanding > 0 ? (amount / totalOutstanding) * 100 : 0;
                  ...
                  <div key={bucket.label} className="group">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs text-muted-foreground w-16 text-right font-numeric">
                          {bucket.count} inv
                        </span>
                      </div>
                    </div>
                    <div
                      className={`h-3 ${bucket.bgColor} rounded-full overflow-hidden`}
                    >
                      <div
