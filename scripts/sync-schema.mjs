...
async function syncSchema() {
  ...
  await addColumnIfNotExists(
    "invoices",
    "amountPaid",
    "DECIMAL(24,8) NOT NULL DEFAULT 0",
    "total"
  );
  await addColumnIfNotExists(
    "invoices",
  ...
  await addColumnIfNotExists(
    "invoiceTemplates",
    "templateType",
    "ENUM('sleek','modern','classic','minimal','bold','professional','creative') NOT NULL DEFAULT 'sleek'",
    "isDefault"
  );
  await addColumnIfNotExists(
    "invoiceTemplates",
    "accentColor",
    "VARCHAR(7) NOT NULL DEFAULT '#10b981'",
    "secondaryColor"
  );
  await addColumnIfNotExists(
    "invoiceTemplates",
    "headingFont",
    "VARCHAR(50) NOT NULL DEFAULT 'Inter'",
    "accentColor"
  );
  await addColumnIfNotExists(
    "invoiceTemplates",
  ...
  await addColumnIfNotExists(
    "invoiceTemplates",
    "headerLayout",
    "ENUM('standard','centered','split') NOT NULL DEFAULT 'standard'",
    "logoWidth"
  );
  await addColumnIfNotExists(
    "invoiceTemplates",
    "footerLayout",
    "ENUM('simple','detailed','minimal') NOT NULL DEFAULT 'simple'",
    "headerLayout"
  );
  await addColumnIfNotExists(
    "invoiceTemplates",
  ...
  await addColumnIfNotExists(
    "invoiceTemplates",
    "dateFormat",
    "VARCHAR(20) NOT NULL DEFAULT 'MM/DD/YYYY'",
    "language"
  );
  ...
  await addColumnIfNotExists(
    "payments",
    "status",
    "ENUM('pending','completed','failed','refunded') NOT NULL DEFAULT 'completed'",
    "receivedDate"
  );
  ...
  await addColumnIfNotExists(
    "emailLog",
    "emailType",
    "ENUM('invoice','reminder','receipt') NOT NULL DEFAULT 'invoice'",
    "subject"
  );
  await addColumnIfNotExists(
    "emailLog",
  ...
  await addColumnIfNotExists(
    "expenseCategories",
    "icon",
    "VARCHAR(50) NOT NULL DEFAULT 'receipt'",
    "color"
  );
